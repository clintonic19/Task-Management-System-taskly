      ...
      <div className='w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center'>
        ...
        <div className='w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center'>
          <form onSubmit={handleSubmit(submitHandler)} className='form-container w-full md:w-[400px] flex flex-col gap-y-8 bg-white px-10 pt-14 pb-14'>
            <div className=''>
              <p className='text-orange-700 text-3xl font-bold text-center'>Welcome to Taskly</p>
            ...
            <div className='flex flex-col gap-y-5'>
              ...
              <Textbox
                ...
                className='w-full rounded-lg'
              />
              <span className='text-sm text-gray-500 cursor-pointer hover:text-orange-700 hover:underline'>Forgot Password?</span>
              <span className='text-sm text-gray-500 cursor-pointer hover:text-orange-700 hover:underline'>Don't have an account?</span>
